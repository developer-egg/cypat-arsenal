    ...
    tab.onclick = () => {
        ...
        switch(tab_index) {
            case 0:
                ...
                document.getElementById("content-link").setAttribute("href", "https://matees.net/blog/linux-checklist/")
                break;
            case 1:
                document.getElementById("content-link").textContent = "Maytham's Ubuntu Script"
                document.getElementById("content-link").setAttribute("href", "https://github.com/maytees/cypat-ubuntu-script")
                break;
            case 2:
                document.getElementById("content-link").textContent = "There's nothing here yet :C"
                document.getElementById("content-link").setAttribute("href", "")
                break;
            case 3:
                document.getElementById("content-link").textContent = "There's nothing here yet :C"
                document.getElementById("content-link").setAttribute("href", "")
